...
namespace CrudClient.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email,Endereco,Telefone")] Clientes clientes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Email,Endereco,Telefone")] Clientes clientes)
        {
            if (id != clientes.Id)
            {
                return NotFound();
